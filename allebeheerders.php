        ...
        <p>Hier staan alle beheerders.</p>
                ...
                //        var_dump($query);
                        ...
                        if($query->rowCount() > 0){
                            echo "<table>";
                            echo "<thead>";
                            echo "<th>id</th><th>Voornaam</th><th>Achternaam</th><th>Tussenvoegsel</th><th>Titel</th><th>Geslacht</th><th>Emailadres</th><th>Verwijderen</th>";
                            echo "</thead><tbody>";
                            foreach($resultq as $data) {
                                echo "<form action='beheerderverwijderen.php' method='POST'>";
                                echo "<tr>";
                                echo "<td>";
                                echo "" . $data['idclient'];
                                echo "</td>";
