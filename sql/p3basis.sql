...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 17 feb 2022 om 12:39
...
--
ALTER TABLE `purchase`
  MODIFY `idpurchase` int(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT voor een tabel `purchaseline`
--
ALTER TABLE `purchaseline`
  MODIFY `idpurchaseline` int(5) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT voor een tabel `type`
--
ALTER TABLE `type`
  MODIFY `idtype` int(5) NOT NULL AUTO_INCREMENT;
COMMIT;
